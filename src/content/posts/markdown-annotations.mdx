---
title: 'Markdown 边注、术语、聊天框与钢琴窗测试'
description: 'MDX 富文本组件的使用说明与渲染测试，包括手绘标注、文章边注、术语原文、聊天记录和交互式钢琴窗。'
...
这篇文章既是本站 Markdown 扩展的使用说明，也是文章边注、术语原文、聊天记录与钢琴窗的渲染测试，当前由 **{contentFormat}** 渲染。

## MDX 组件

本站将复杂的富文本能力注册为全局 MDX 组件。文章可以直接使用手绘标注、术语、边注、聊天框和钢琴窗组件，无需在每篇文章中重复导入。普通 Markdown 继续使用 Astro 默认渲染器，适合不需要组件的内容。
